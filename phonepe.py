...
def  Transaction_amount_count_Y(df,year):
    ...
    with col2:
        ...
        fig_count= px.bar(tacyg, x="States", y="Transaction_count",title=f"{year} TRANSACTION COUNT",
                        color_discrete_sequence= px.colors.sequential.Bluered_r,height=500,width=500)
...
def  Transaction_amount_count_Y_Q(df,quarter):
    ...
    with col2:
        fig_count= px.bar(tacyg, x="States", y="Transaction_count",title=f"{tacy['Years'].min()} Year {quarter} QUARTER TRANSACTION COUNT",
                        color_discrete_sequence= px.colors.sequential.Bluered,height=500,width=500)
        st.plotly_chart(fig_count)
...
def Agg_user_plot_2(df,quarter):
    ...
    fig_bar_1=px.bar(aguyqg, x="Brands", y="Transaction_count",title=f"{quarter} QUARTER, BRANDS AND TRANSACTION COUNT",
                        width=800,color_discrete_sequence=px.colors.sequential.Tealgrn_r)
    st.plotly_chart(fig_bar_1)
    return aguyq
...
def Agg_user_plot_3(df,state):
    ...
    fig_line_1=px.line(auygs, x="Brands",y="Transaction_count",hover_data="Percentage",
...
def Map_insur_Districts(df,state):
    ...
    col1,col2= st.columns(2)
    with col1:
        fig_bar_1= px.bar(tacyg, x= "Transaction_amount",y= "Districts",orientation= "h",height=500,
                        title= f"{state.upper()} DISTRICTS AND TRANSACTION AMOUNT", color_discrete_sequence=px.colors.sequential.Mint_r)
        st.plotly_chart(fig_bar_1)
  
    with col2:
        fig_bar_2= px.bar(tacyg, x= "Transaction_count",y= "Districts",orientation= "h",height=500,
...
def map_user_plot_2(df,quarter):
    ...
    fig_line_2=px.line(muyqg, x="States",y=["RegisteredUser", "AppOpens"],
...
def map_user_plot_3(df,states):
    ...
    with col1:
        fig_map_user_bar_1=px.bar(muyqs, x= "RegisteredUser",y= "Districts", orientation= "h",
                                title= f"{states.upper()} REGISTERED USER",height=600,color_discrete_sequence=px.colors.sequential.Rainbow_r)
        st.plotly_chart(fig_map_user_bar_1)
    with col2:
        fig_map_user_bar_2=px.bar(muyqs, x= "AppOpens",y= "Districts", orientation= "h",
                                title= f"{states.upper()} APPOPENS ",height=500,color_discrete_sequence=px.colors.sequential.Agsunset)
...
def Top_insurance_plot_1(df,state):
            ...
            with col1:
                fig_top_insur_bar_1=px.bar(tiy, x= "Quarter",y= "Transaction_amount", hover_data= "Pincodes",
                                            title= "TRANSACTION AMOUNT",height=800,width=700,color_discrete_sequence=px.colors.sequential.GnBu_r)
...
def top_user_plot_2(df,state):
    ...
    fig_top_plot_2=px.bar(tuys, x="Quarter",y= "RegisteredUser",color="RegisteredUser", title= "REGISTEREDUSER,PINCODES,QUARTER",
                        width=1000,height=800,hover_data="Pincodes",
...
def top_chart_registered_user(table_name,state):
    ...
    df_2=pd.DataFrame(table_2, columns=("districts","registetreduser"))

    with col2:
        fig_amount_2= px.bar(df_2, x="districts", y="registetreduser",title="LAST 10 OF REGISTERED USER",hover_name="districts",
                                color_discrete_sequence= px.colors.sequential.Aggrnyl_r,height=650,width=600)
        st.plotly_chart(fig_amount_2)
    ...
    fig_amount_3= px.bar(df_3, x="districts", y="registereduser",title="AVERAGE OF REGISTERED USER",hover_name="districts",
...
#plot_2
    ...
    df_2=pd.DataFrame(table_2, columns=("states","registetreduser"))

    with col2:
            fig_amount_2= px.bar(df_2, x="states", y="registetreduser",title="LAST 10 OF REGISTERED USER",hover_name="states",
                                    color_discrete_sequence= px.colors.sequential.Aggrnyl_r,height=650,width=600)
            st.plotly_chart(fig_amount_2)
...
#plot_3
    ...
    fig_amount_3= px.bar(df_3, x="states", y="registereduser",title="AVERAGE OF REGISTERED USER",hover_name="states",
                                color_discrete_sequence= px.colors.sequential.Bluered,height=800,width=1000)
    st.plotly_chart(fig_amount_3)
#streamlit part
...
if select=="HOME":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\KAAY\Desktop\phonepe\phonepe1.png"),width=400)
        

    col3,col4= st.columns(2)
    
    with col3:
         st.image(Image.open(r"C:\Users\KAAY\Desktop\phonepe\download.jpg"),width=300)
    ...
    with col6:
        st.image(Image.open(r"C:\Users\KAAY\Desktop\phonepe\phonepe3.png"),width= 500)
   ...
   with tab1:
     ...
     if method =="Insurance Analysis":
         ...
         col1,col2=st.columns(2)
         with col1:
               state=st.selectbox("Select The State",Agg_tran_tac_Y["State"].unique())
         
         Agg_Tran_Transaction_type(Agg_tran_tac_Y,state)
         ...
         col1,col2=st.columns(2)
         with col1:
               state=st.selectbox("Select The State_Ty",Agg_tran_tac_Y["States"].unique())
         Agg_Tran_Transaction_type(Agg_tran_tac_Y_Q,state)
          ...
          col1,col2=st.columns(2)
          with col1:
               state=st.selectbox("Select The State_Ty",Agg_user_Y_Q["States"].unique())
   ...
   with tab2:
      ...
      if method_2 == "Map Insurance":
          ...
          with col1:
            ...
            years= st.slider("Select The Years_mi",map_insurance["Years"].min(), map_insurance["Years"].max(), map_insurance["Years"].min())
        ...
        col1,col2=st.columns(2)
        with col1:
         state=st.selectbox("Select The State_mi",map_tran_tac_Y["States"].unique())
    ...
    if question == "1. Transaction Amount and Count of Aggregated Insurance":
        ...
        top_chart_registered_user("map_user") 
